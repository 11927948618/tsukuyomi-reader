...
- `51-spread-view-redesign.md`
  - 見開き表示（縦積み・横積み）の再設計メモ。設定集約・4象限レイアウト・実寸判定。
- `52-large-book-rendering.md`
  - 大容量書籍（最大30万字）の描画方針。スクロールモード仮想化・トークン化 async 化・
    blob URL 解放・initReader ティアダウン。

## 履歴・引継ぎ

- `90-handoff-20260701.md`
  - TsukuyomiReaderの現状、表示まわりの注意点、検証、デプロイ手順。
- `91-handoff-update-20260702.md`
  - Adminアップロード障害、モバイルファイル送信TIPS、0.1.165から0.1.167の更新差分。
